...
public interface ExpressionFactory {
     ...
     * @param value value - A constant long value of the expression.
    ...
    /**
     * Construct an operator based on the given identifying name and with the provided operator arguments.
     ...
     * @throws InvalidExpression If the operator name is invalid (i.e. not known), or the arguments to the operator are inappropriate
     * (e.g. wrong type, too few, too many, etc).
     */
